...
<div class="card card-body min-height-400 border-radius-xl mt-2">
<div class="row mb-5">
  <div class="col-md-12">
    <h1>Update About</h1>
    <div class="row">
      ...
      <?=@$pesan?>
        <form action="" method="post">
          <div class="form-group">
            ...
            <textarea name="column1" id="" cols="25" rows="10"><?=$data['column1']?></textarea>
          </div>
          <div class="form-group">
            <label for="">Kolom 2</label>
            <textarea name="column2" id="" cols="25" rows="10"><?=$data['column2']?></textarea>
          </div>
