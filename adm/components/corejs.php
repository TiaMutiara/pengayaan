            ...
            <div class="row align-items-center justify-content-lg-between">
              <div class="col-lg-6 mb-lg-0 mb-4">
                <div class="copyright text-center text-sm text-muted text-lg-start">
                  ...
                  , made with <i class="fa fa-heart"></i> by Tia Mutiara</a>
                </div>
              </div>
              <div class="col-lg-6">
                <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                  <li class="nav-item">
                    <a href="https://m.facebook.com/thia.diamond" class="nav-link text-muted" target="_blank">Tia Mutiara</a>
                  </li>
                  <li class="nav-item">
                    <a href="https://www.instagram.com/tmutiara_" class="nav-link text-muted" target="_blank">tmutiara_</a>
                  </li>
                </ul>
              </div>
            </div>
