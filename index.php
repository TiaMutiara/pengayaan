...
<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron text-center" >
      <img src="<?= $user["foto"];?>" alt="" width="400" class="rounded-circle img-thumbnail" data-aos="zoom-in" />
      <h1 class="display-5" data-aos="fade-up"
     data-aos-anchor-placement="bottom-bottom"><?= $user["nama"];?> </h1>
      <p class="lead" data-aos="fade-up"><?= $user["jabatan"];?> | <?= $user["perusahaan"];?></p>
